...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c1:
            st.text('VLF -60 s a -30 s: ' + str(round((10**15)*vlf_60minus_30minus,3)))
            st.text('VLF -30 s a 0 s: ' + str(round((10**15)*vlf_30minus_start,3)))
            st.text('VLF 0 s a 30 s: ' + str(round((10**15)*vlf_start_30plus,3)))
            st.text('VLF 30 s a 60 s: ' + str(round((10**15)*vlf_30plus_60plus,3)))
            st.text('VLF 60 s a 90 s: ' + str(round((10**15)*vlf_60plus_90plus,3)))
            st.text('VLF 90 s a 120 s: ' + str(round((10**10)*vlf_90plus_120plus,3)))
            st.text('VLF 120 s a 150 s: ' + str(round((10**10)*vlf_120plus_150plus,3)))
            st.text('VLF 150 s a 180 s: ' + str(round((10**10)*vlf_150plus_180plus,3)))
            st.text('VLF 180 s a 210 s: ' + str(round((10**10)*vlf_180plus_210plus,3)))
            st.text('VLF 210 s a 240 s: ' + str(round((10**10)*vlf_210plus_240plus,3)))
            st.text('VLF 240 s a 270 s: ' + str(round((10**10)*vlf_240plus_270plus,3)))
            st.text('VLF 270 s a 300 s: ' + str(round((10**10)*vlf_270plus_300plus,3)))
        with c2:    
            st.text('LF -60 s a -30 s: ' + str((10**12)*round(lf_60minus_30minus,3)))
            st.text('LF -30 s a 0 s: ' + str((10**12)*round(lf_30minus_start,3)))
            st.text('LF 0 s a 30 s: ' + str((10**12)*round(lf_start_30plus,3)))
            st.text('LF 30 s a 60 s: ' + str((10**12)*round(lf_30plus_60plus,3)))
            st.text('LF 60 s a 90 s: ' + str((10**12)*round(lf_60plus_90plus,3)))
            st.text('LF 90 s a 120 s: ' + str((10**12)*round(lf_90plus_120plus,3)))
            st.text('LF 120 s a 150 s: ' + str((10**12)*round(lf_120plus_150plus,3)))
            st.text('LF 150 s a 180 s: ' + str((10**12)*round(lf_150plus_180plus,3)))
            st.text('LF 180 s a 210 s: ' + str((10**12)*round(lf_180plus_210plus,3)))
            st.text('LF 210 s a 240 s: ' + str((10**12)*round(lf_210plus_240plus,3)))
            st.text('LF 240 s a 270 s: ' + str((10**12)*round(lf_240plus_270plus,3)))
            st.text('LF 270 s a 300 s: ' + str((10**12)*round(lf_270plus_300plus,3)))
        with c3:    
            st.text('HF -60 s a -30 s: ' + str((10**15)*round(hf_60minus_30minus,3)))
            st.text('HF -30 s a 0 s: ' + str((10**15)*round(hf_30minus_start,3)))
            st.text('HF 0 s a 30 s: ' + str((10**15)*round(hf_start_30plus,3)))
            st.text('HF 30 s a 60 s: ' + str((10**15)*round(hf_30plus_60plus,3)))
            st.text('HF 60 s a 90 s: ' + str((10**15)*round(hf_60plus_90plus,3)))
            st.text('HF 90 s a 120 s: ' + str((10**15)*round(hf_90plus_120plus,3)))
            st.text('HF 120 s a 150 s: ' + str((10**15)*round(hf_120plus_150plus,3)))
            st.text('HF 150 s a 180 s: ' + str((10**15)*round(hf_150plus_180plus,3)))
            st.text('HF 180 s a 210 s: ' + str((10**15)*round(hf_180plus_210plus,3)))
            st.text('HF 210 s a 240 s: ' + str((10**15)*round(hf_210plus_240plus,3)))
            st.text('HF 240 s a 270 s: ' + str((10**15)*round(hf_240plus_270plus,3)))
            st.text('HF 270 s a 300 s: ' + str((10**15)*round(hf_270plus_300plus,3)))    
        with c4:    
