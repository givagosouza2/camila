...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c2:    
            st.text('LF -60 s a -30 s: ' + str(round((10**12)*lf_60minus_30minus,3)))
            st.text('LF -30 s a 0 s: ' + str(round((10**12)*lf_30minus_start,3)))
            st.text('LF 0 s a 30 s: ' + str(round((10**12)*lf_start_30plus,3)))
            st.text('LF 30 s a 60 s: ' + str(round((10**12)*lf_30plus_60plus,3)))
            st.text('LF 60 s a 90 s: ' + str(round((10**12)*lf_60plus_90plus,3)))
            st.text('LF 90 s a 120 s: ' + str(round((10**12)*lf_90plus_120plus,3)))
            st.text('LF 120 s a 150 s: ' + str(round((10**12)*lf_120plus_150plus,3)))
            st.text('LF 150 s a 180 s: ' + str(round((10**12)*lf_150plus_180plus,3)))
            st.text('LF 180 s a 210 s: ' + str(round((10**12)*lf_180plus_210plus,3)))
            st.text('LF 210 s a 240 s: ' + str(round((10**12)*lf_210plus_240plus,3)))
            st.text('LF 240 s a 270 s: ' + str(round((10**12)*lf_240plus_270plus,3)))
            st.text('LF 270 s a 300 s: ' + str(round((10**12)*lf_270plus_300plus,3)))
        with c3:    
