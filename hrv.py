...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c4:    
            st.text('LFHF -60 s a -30 s: ' + str(round(lf_hf_60minus_30minus,3)))
            st.text('LFHF -30 s a 0 s: ' + str(round(lf_hf_30minus_start,3)))
            st.text('LFHF 0 s a 30 s: ' + str(round(lf_hf_start_30plus,3)))
            st.text('LFHF 30 s a 60 s: ' + str(round(lf_hf_30plus_60plus,3)))
            st.text('LFHF 60 s a 90 s: ' + str(round(lf_hf_60plus_90plus,3)))
            st.text('LFHF 90 s a 120 s: ' + str(round(lf_hf_90plus_120plus,3)))
            st.text('LFHF 120 s a 150 s: ' + str(round(lf_hf_120plus_150plus,3)))
            st.text('LFHF 150 s a 180 s: ' + str(round(lf_hf_150plus_180plus,3)))
            st.text('LFHF 180 s a 210 s: ' + str(round(lf_hf_180plus_210plus,3)))
            st.text('LFHF 210 s a 240 s: ' + str(round(lf_hf_210plus_240plus,3)))
            st.text('LFHF 240 s a 270 s: ' + str(round(lf_hf_240plus_270plus,3)))
            st.text('LFHF 270 s a 300 s: ' + str(round(lf_hf_270plus_300plus,3)))        
