...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c3:    
            st.text('HF -60 s a -30 s: ' + str(round((10**15)*hf_60minus_30minus,3)))
            st.text('HF -30 s a 0 s: ' + str(round((10**15)*hf_30minus_start,3)))
            st.text('HF 0 s a 30 s: ' + str(round((10**15)*hf_start_30plus,3)))
            st.text('HF 30 s a 60 s: ' + str(round((10**15)*hf_30plus_60plus,3)))
            st.text('HF 60 s a 90 s: ' + str(round((10**15)*hf_60plus_90plus,3)))
            st.text('HF 90 s a 120 s: ' + str(round((10**15)*hf_90plus_120plus,3)))
            st.text('HF 120 s a 150 s: ' + str(round((10**15)*hf_120plus_150plus,3)))
            st.text('HF 150 s a 180 s: ' + str(round((10**15)*hf_150plus_180plus,3)))
            st.text('HF 180 s a 210 s: ' + str(round((10**15)*hf_180plus_210plus,3)))
            st.text('HF 210 s a 240 s: ' + str(round((10**15)*hf_210plus_240plus,3)))
            st.text('HF 240 s a 270 s: ' + str(round((10**15)*hf_240plus_270plus,3)))
            st.text('HF 270 s a 300 s: ' + str(round((10**15)*hf_270plus_300plus,3)))    
        with c4:    
