...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c1:
            ...
            st.text('VLF 0 s a 30 s: ' + str((10**9)*vlf_start_30plus))
            st.text('VLF 30 s a 60 s: ' + str((10**9)*vlf_30plus_60plus))
            st.text('VLF 60 s a 90 s: ' + str((10**9)*vlf_60plus_90plus))
            st.text('VLF 90 s a 120 s: ' + str((10**9)*vlf_90plus_120plus))
            st.text('VLF 120 s a 150 s: ' + str((10**9)*vlf_120plus_150plus))
            st.text('VLF 150 s a 180 s: ' + str((10**9)*vlf_150plus_180plus))
            st.text('VLF 180 s a 210 s: ' + str((10**9)*vlf_180plus_210plus))
            st.text('VLF 210 s a 240 s: ' + str((10**9)*vlf_210plus_240plus))
            st.text('VLF 240 s a 270 s: ' + str((10**9)*vlf_240plus_270plus))
            st.text('VLF 270 s a 300 s: ' + str((10**9)*vlf_270plus_300plus))
        with c2:    
            st.text('LF -60 s a -30 s: ' + str((10**9)*lf_60minus_30minus))
            st.text('LF -30 s a 0 s: ' + str((10**9)*lf_30minus_start))
            st.text('LF 0 s a 30 s: ' + str((10**9)*lf_start_30plus))
            st.text('LF 30 s a 60 s: ' + str((10**9)*lf_30plus_60plus))
            st.text('LF 60 s a 90 s: ' + str((10**9)*lf_60plus_90plus))
            st.text('LF 90 s a 120 s: ' + str((10**9)*lf_90plus_120plus))
            st.text('LF 120 s a 150 s: ' + str((10**9)*lf_120plus_150plus))
            st.text('LF 150 s a 180 s: ' + str((10**9)*lf_150plus_180plus))
            st.text('LF 180 s a 210 s: ' + str((10**9)*lf_180plus_210plus))
