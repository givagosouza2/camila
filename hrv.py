...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c1:
            st.text('VLF -60 a -30 s: ' + str(round((10**9)*vlf_60minus_30minus,3)))
            st.text('VLF -30 a 0 s: ' + str(round((10**9)*vlf_30minus_start,3)))
            st.text('VLF 0 a 30 s: ' + str(round((10**9)*vlf_start_30plus,3)))
            st.text('VLF 30 a 60 s: ' + str(round((10**9)*vlf_30plus_60plus,3)))
            st.text('VLF 60 a 90 s: ' + str(round((10**9)*vlf_60plus_90plus,3)))
            st.text('VLF 90 a 120 s: ' + str(round((10**9)*vlf_90plus_120plus,3)))
            st.text('VLF 120 a 150 s: ' + str(round((10**9)*vlf_120plus_150plus,3)))
            st.text('VLF 150 a 180 s: ' + str(round((10**9)*vlf_150plus_180plus,3)))
            st.text('VLF 180 a 210 s: ' + str(round((10**9)*vlf_180plus_210plus,3)))
            st.text('VLF 210 a 240 s: ' + str(round((10**9)*vlf_210plus_240plus,3)))
            st.text('VLF 240 a 270 s: ' + str(round((10**9)*vlf_240plus_270plus,3)))
            st.text('VLF 270 a 300 s: ' + str(round((10**9)*vlf_270plus_300plus,3)))
        with c2:    
            st.text('LF -60 a -30 s: ' + str(round((10**11)*lf_60minus_30minus,3)))
            st.text('LF -30 a 0 s: ' + str(round((10**11)*lf_30minus_start,3)))
            st.text('LF 0 a 30 s: ' + str(round((10**11)*lf_start_30plus,3)))
            st.text('LF 30 a 60 s: ' + str(round((10**11)*lf_30plus_60plus,3)))
            st.text('LF 60 a 90 s: ' + str(round((10**11)*lf_60plus_90plus,3)))
            st.text('LF 90 a 120 s: ' + str(round((10**11)*lf_90plus_120plus,3)))
            st.text('LF 120 a 150 s: ' + str(round((10**11)*lf_120plus_150plus,3)))
            st.text('LF 150 a 180 s: ' + str(round((10**11)*lf_150plus_180plus,3)))
            st.text('LF 180 a 210 s: ' + str(round((10**11)*lf_180plus_210plus,3)))
            st.text('LF 210 a 240 s: ' + str(round((10**11)*lf_210plus_240plus,3)))
            st.text('LF 240 a 270 s: ' + str(round((10**11)*lf_240plus_270plus,3)))
            st.text('LF 270 a 300 s: ' + str(round((10**11)*lf_270plus_300plus,3)))
        with c3:    
            st.text('HF -60 a -30 s: ' + str(round((10**13)*hf_60minus_30minus,3)))
            st.text('HF -30 a 0 s: ' + str(round((10**13)*hf_30minus_start,3)))
            st.text('HF 0 a 30 s: ' + str(round((10**13)*hf_start_30plus,3)))
            st.text('HF 30 a 60 s: ' + str(round((10**13)*hf_30plus_60plus,3)))
            st.text('HF 60 a 90 s: ' + str(round((10**13)*hf_60plus_90plus,3)))
            st.text('HF 90 a 120 s: ' + str(round((10**13)*hf_90plus_120plus,3)))
            st.text('HF 120 a 150 s: ' + str(round((10**13)*hf_120plus_150plus,3)))
            st.text('HF 150 a 180 s: ' + str(round((10**13)*hf_150plus_180plus,3)))
            st.text('HF 180 a 210 s: ' + str(round((10**13)*hf_180plus_210plus,3)))
            st.text('HF 210 a 240 s: ' + str(round((10**13)*hf_210plus_240plus,3)))
            st.text('HF 240 a 270 s: ' + str(round((10**13)*hf_240plus_270plus,3)))
            st.text('HF 270 a 300 s: ' + str(round((10**13)*hf_270plus_300plus,3)))    
        with c4:    
            st.text('LFHF -60 a -30 s: ' + str(round(lf_hf_60minus_30minus,2)))
            st.text('LFHF -30 a 0 s: ' + str(round(lf_hf_30minus_start,2)))
            st.text('LFHF 0 a 30 s: ' + str(round(lf_hf_start_30plus,2)))
            st.text('LFHF 30 a 60 s: ' + str(round(lf_hf_30plus_60plus,2)))
            st.text('LFHF 60 a 90 s: ' + str(round(lf_hf_60plus_90plus,2)))
            st.text('LFHF 90 a 120 s: ' + str(round(lf_hf_90plus_120plus,2)))
            st.text('LFHF 120 a 150 s: ' + str(round(lf_hf_120plus_150plus,2)))
            st.text('LFHF 150 a 180 s: ' + str(round(lf_hf_150plus_180plus,2)))
            st.text('LFHF 180 a 210 s: ' + str(round(lf_hf_180plus_210plus,2)))
            st.text('LFHF 210 a 240 s: ' + str(round(lf_hf_210plus_240plus,2)))
