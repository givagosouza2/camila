...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c1:
            st.text('VLF -60 s a -30 s: ' + str((10**9)*round(vlf_60minus_30minus,3)))
            st.text('VLF -30 s a 0 s: ' + str((10**9)*round(vlf_30minus_start,3)))
            st.text('VLF 0 s a 30 s: ' + str((10**9)*round(vlf_start_30plus,3)))
            st.text('VLF 30 s a 60 s: ' + str((10**9)*round(vlf_30plus_60plus,3)))
            st.text('VLF 60 s a 90 s: ' + str((10**9)*round(vlf_60plus_90plus,3)))
            st.text('VLF 90 s a 120 s: ' + str((10**9)*round(vlf_90plus_120plus,3)))
            st.text('VLF 120 s a 150 s: ' + str((10**9)*round(vlf_120plus_150plus,3)))
            st.text('VLF 150 s a 180 s: ' + str((10**9)*round(vlf_150plus_180plus,3)))
            st.text('VLF 180 s a 210 s: ' + str((10**9)*round(vlf_180plus_210plus,3)))
            st.text('VLF 210 s a 240 s: ' + str((10**9)*round(vlf_210plus_240plus,3)))
            st.text('VLF 240 s a 270 s: ' + str((10**9)*round(vlf_240plus_270plus,3)))
            st.text('VLF 270 s a 300 s: ' + str((10**9)*round(vlf_270plus_300plus,3)))
        with c2:    
