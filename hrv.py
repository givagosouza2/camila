...
with col1:
    ...
    if uploaded_file is not None:
        ...
        with c1:
            ...
            st.text('VLF 180 s a 210 s: ' + str((10**10)*round(vlf_180plus_210plus,3)))
            st.text('VLF 210 s a 240 s: ' + str((10**10)*round(vlf_210plus_240plus,3)))
            st.text('VLF 240 s a 270 s: ' + str((10**10)*round(vlf_240plus_270plus,3)))
            st.text('VLF 270 s a 300 s: ' + str((10**10)*round(vlf_270plus_300plus,3)))
        with c2:    
